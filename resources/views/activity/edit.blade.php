@extends('layouts.app', ['title' => 'Add Activity', 'breadcumb' => 'Add Activity'])
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">General Form Activity</h6>
            </div>
                <div class="card-body">
                 <form action="{{ route('activity.update', $activity->uuid_activity)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @method('PUT')
                    @include('activity.partials.form-control')
                </form>
            </div>
        </div>
    </div>
