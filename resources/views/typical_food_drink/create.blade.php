    ...
    <div class="row mb-3">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                 <form action="{{ route('typical_food_drink.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @include('typical_food_drink.partials.form-control', ['submit' => 'Submit'])
                </form>
            </div>
        </div>
    </div>
