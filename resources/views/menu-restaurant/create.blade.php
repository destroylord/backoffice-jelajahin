...
<div class="row">
    <div class="col-lg-8">
        <div class="card mb-4">
            ...
            <form action="{{ route('menu-restaurant.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @include('menu-restaurant.partials.form-control', ['submit' => 'Submit'])
            </form>
        </div>
    </div>
</div>
